...
public class BankApp {
    public static void main(String[] args) {
        ...
        LoanConsumer agatha = new LoanConsumer("Agatha", 55, 5000);
        ...
        printIssue(employees, consumer);
    }

    private static void printIssue(LoanIssuer[] employees, LoanConsumer[] consumer) {
